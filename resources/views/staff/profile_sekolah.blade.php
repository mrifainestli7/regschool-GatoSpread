                                        ...
                                        <div class="dropdown ml-auto">
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu rounded-4" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <li><a class="dropdown-item" href="#" style="background-color: #e15555;" data-bs-toggle="modal" data-bs-target="#deleteModal">Hapus Data Sekolah</a></li>
                                                </ul>
                                            </li>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Konfirmasi Hapus Data Sekolah</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data sekolah ini? Tindakan ini tidak dapat dibatalkan.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    <form action="{{ route('staff.hapus_sekolah', ['id_sekolah' => $sekolah->id_sekolah ?? 0]) }}" method="GET">
                        @csrf
