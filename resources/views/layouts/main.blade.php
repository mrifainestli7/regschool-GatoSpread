                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="tambah-kecamatan" class="sidebar-link">Kecamatan</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="tambah-sekolah" class="sidebar-link">Sekolah</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        <a href="profile" class="sidebar-link"><i class="fa-regular fa-user pe-2"></i>
                            Profile
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link"><i class="fa-solid fa-sign-out-alt pe-2"></i>
                            Log Out
                        </a>  
                    </li>                   
                </ul>
